            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-11"><input type="text" name="nome" size="150" maxlength="100" value="<?php echo trim($registro['nome_cliente']); ?>" ></div>

                        <div class="form-group col-md-1">CPF:</div>
                        <div class="form-group col-md-11"><input type="text" name="cpf" size="50"  maxlength="11"  value="<?php echo trim($registro['cpf']); ?>"></div>

                        <div class="form-group col-md-1">Email:</div>
                        <div class="form-group col-md-11"><input type="text" name="email" size="150"  maxlength="100"  value="<?php echo trim($registro['email']); ?>"></div>
